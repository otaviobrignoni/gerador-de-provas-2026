...
namespace GeradorDeProvas.Infra.Compartilhado.Orm.Migrations
{
    ...
    [Migration("20260807022051_Add_Ordem_Questoes_Prova")]
    partial class Add_Ordem_Questoes_Prova
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeradorDeProvas.Dominio.ModuloProva.Prova", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TBProvaQuestao", b =>
                {
                    b.HasOne("GeradorDeProvas.Dominio.ModuloProva.Prova", null)
                        .WithMany()
                        .HasForeignKey("ProvasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GeradorDeProvas.Dominio.ModuloQuestao.Questao", null)
                        .WithMany()
